public class Card {
    	...
    	public Card(byte vle, char fce){ // initialized with values
    		value = vle;
    		suit = fce;
    	}
    	...
    	public static Card decode(short cardShort){ // this decodes the short to a new card
    		...
    		return new Card(cardShort % 13, faceValue == 0 ? "Hearts" : 
    	...
    	public String toString(){ // displays it as a string
    		if(value > 10){ // checks if it is a face card
    		
    			String face = value == 11 ? "Jack" : value == 12 ? "Queen" : "King";
